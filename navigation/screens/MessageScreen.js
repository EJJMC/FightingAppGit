...
//     // Create a query to filter messages by recipientID and orderBy timestamp
...
//       ...prevMessages,
//       { text: message, sender: "me", timestamp: new Date().toISOString() },
//     ]);
...
//             style={[
//               styles.message,
//               msg.sender === user.uid ? styles.otherMessage : styles.myMessage,
//             ]}
//           >
//             <Text
//               style={
